...
_router.post('/photo', getUser, _base64ToFile("uploads[]"), _reportController.save.bind(_reportController));
_router.post('/message', getUser, _reportController.save.bind(_reportController));
